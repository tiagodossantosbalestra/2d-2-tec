...
('Yara pereira', 'Biologia', 5200.00, 'PR'),
('Victor Rocha', 'filosofia', 4600.00, 'MS'),
('Gustavo Rego', 'arte', 5200.00, 'SP');
...
('gleuber santos', 'M', '2001-06-10', 7.6, true),
('Eduarda Campos', 'F', '2003-04-14', 9.6, true), 
...
('Direito', 3000, 'EAD'),
('ciencias humanas' 3400, 'Presncial');
